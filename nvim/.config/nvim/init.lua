...
-- Set conceallevel to 2, so markdown looks pretty, if json fucks around - its this lines fault
...
--
-- NOTE: This won't work in all terminal emulators/tmux/etc. Change to your own mapping
...
--  Use CTRL+<hjkl> to switch between windows // taken by tmux already :(
--
...
--    :Lazy update
--
-- NOTE: This is where you install your plugins!!!
require('lazy').setup({
        ...
        rust_analyzer = {
          settings = {
            ['rust-analyzer'] = {
              ...
              check = {
                command = 'clippy',
                -- pedantic clippy - my G help me write clean code pleaseeee
                extraArgs = {
                  '--',
                  '-Wclippy::all',
                  '-Wclippy::pedantic',
  ...
  { -- Highlight, edit, and navigate code
    ...
    opts = {
      ...
      highlight = {
        ...
        -- catppuccin theme highlights way better by default
        -- BUG: (but in telescope it still shows, too lazy to get rid of it)
        -- ((auto install's fault))
        disable = { 'csv' },
      },
  ...
  -- WARN: these only work if you have downloaded the kickstart repo, not only copied the init.lua
  --  Here are some example plugins that I've included in the Kickstart repository.
  --  Uncomment any of the lines below to enable them (needs restart).
  --
